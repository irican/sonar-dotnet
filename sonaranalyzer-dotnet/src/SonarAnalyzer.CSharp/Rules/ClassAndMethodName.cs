...
namespace SonarAnalyzer.Rules.CSharp
{
    ...
    public sealed class ClassAndMethodName : SonarDiagnosticAnalyzer
    {
        ...
        private const string MessageFormat = "请重命名{0} '{1}' 以符合帕斯卡命名规则，{2}。"; //0->TypeKindNameMapping[value] 2->MessageFormatNonUnderscore|MessageFormatUnderscore
        ...
        private static readonly Dictionary<SyntaxKind, string> TypeKindNameMapping =
            ...
            {
                { SyntaxKind.StructDeclaration, "结构体" },  //struct
                { SyntaxKind.ClassDeclaration, "类" },       //class
                { SyntaxKind.InterfaceDeclaration, "接口" }, //interface
                { SyntaxKind.MethodDeclaration, "方法" },    //method
                { SyntaxKind.PropertyDeclaration, "属性" }   //property
            };
