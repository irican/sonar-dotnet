...
namespace SonarAnalyzer.Rules.CSharp
{
    ...
    {
        internal const string TitleRemoveBaseCall = "移除 'base()' 调用";
        internal const string TitleRemoveConstructor = "移除构造器";
        internal const string TitleRemoveDestructor = "移除析构函数";
